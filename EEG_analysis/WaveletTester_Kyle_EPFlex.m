...
data = EEG_P3_WFilt(:,2)'; %1000:53000
...
centered_spectra = B-repmat(mean_spectra,1,size(B,2));
...
% xf=1:100:length(freq); % to get log-sampled frequency tick marks
...
figure; 
% subplot(3,3,4:5); 
xf=1:8:length(F); % to get log-sampled frequency tick marks
centered_spectra(centered_spectra<0) = 0;
